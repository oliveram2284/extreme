...
$_['text_token_register']			= 'Registrate en su ficha eBay';
$_['text_token_renew']				= 'Renueve su token eBay';
$_['text_application_settings']		= 'Sus parámetros de la aplicación le permiten configurar OpenBay Pro y se integra con su sistema.';
...
$_['text_payments_description']		= 'Pre poblar sus opciones de pago para los nuevos productos, esto le ahorrará entrar para cada nuevo producto que cree.';
$_['text_allocate_1']				= 'Cuando el cliente compra';
$_['text_allocate_2']				= 'Cuando el cliente halla pagado';
$_['text_developer_description']	= 'Usted no debe usar esta área a menos que se lo indique';
$_['text_payment_paypal']			= 'PayPal aceptado';
$_['text_payment_paypal_add']		= 'Dirección email de PayPal';
$_['text_payment_cheque']			= 'Cheque aceptado';
$_['text_payment_card']				= 'Tarjetas aceptadas';
$_['text_payment_desc']				= 'Ver descripción (ej. transferencia bancaria)';
$_['text_tax_use_listing'] 			= 'Use tax rate set in eBay listing';
$_['text_tax_use_value']			= 'Use a set value for everything';
$_['text_tax_use_product']			= 'Calcular el impuesto en función del país comprador y el tipo de impuesto';
$_['text_notifications']			= 'Controle cuando los clientes reciben notificaciones desde la aplicación. Activar los mensajes de correo electrónico de actualización pueden mejorar sus calificaciones de DSR, como usuario recibirá actualizaciones acerca de su pedido.';
...
$_['text_api_failed']               = 'Error de validación';
$_['text_api_other']        		= 'Otras acciones';
$_['text_create_date_0']            = 'Cuando se añade a OpenCart';
$_['text_create_date_1']            = 'Cuando fue creado en eBay';
$_['text_obp_detail_update']        = 'Actualizar URL de Tienda &amp; email de contacto';
$_['text_success']					= 'Tu configuración se ha guardado';
$_['text_edit']						= 'Editar configuración de eBay';
...
$_['entry_duration']				= 'Por defecto duración lista';

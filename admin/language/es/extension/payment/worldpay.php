...
$_['text_success']				 = 'Correcto: &iexcl;Ha modificado la configuración de Worldpay!';
...
$_['text_release_ok']		 	 = 'Enviado correctamnet';
$_['text_release_ok_order']		 = 'Enviado correctamente, el estado del pedido se actualizó correctamente';
$_['text_refund_ok']			 = 'Reembolso correcto';
$_['text_refund_ok_order']		 = 'Reembolso correcto, estado del pedido actualizado a reembolsado';
$_['text_void_ok']				 = 'Anulado correctamente, el estado del pedido se actualizó en anulado';
...
// Help
$_['help_total']				 = 'Importe mínimo necesario, en le pedido, para que esta opción de pago se active';
$_['help_debug']				 = 'Habilitar esta opción reescribirá datos sensibles en un archivo de registro. Tener esta opción deshabilitada a menos que se le indique lo contrario';
$_['help_secret_token']			 = "Utilizar una clave larga y difícil de adivinar";
...
// Error
$_['error_permission']			 = 'Advertencia: &iexcl;No dispone de permisos para modificar Worldpay!';
...
$_['text_refund_status']		 = 'Pago de reembolso';
...
$_['text_column_date_added']	 = 'Adicional';

$_['text_confirm_refund']		 = '¿Seguro que desea reintegrar el pago?';

$_['btn_refund']				 = 'Rebate / reembolso';
...
<script src="view/javascript/jquery/color-picker/js/bootstrap-colorpicker.js" type="text/javascript"></script>
<link href="view/javascript/jquery/color-picker/css/bootstrap-colorpicker.css" type="text/css" rel="stylesheet" media="screen" />
